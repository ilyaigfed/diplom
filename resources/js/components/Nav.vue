        ...
        <v-list class="pt-0" dense>
            ...
            <template v-if="user">
                ...
                <v-list-group prepend-icon="list" v-if="user">
                    ...
                    <v-list-tile :to="`/profile/${user.link}/liked`">
                        <v-list-tile-title>Понравившиеся</v-list-tile-title>
                        <v-list-tile-action>
    ...
    export default {
        ...
        data() { return {
            items: [
                ...
                { title: 'Обновления', icon: 'person_pin', color: 'orange', to: '/stream' },
                { title: 'Попробовать Pro', icon: 'grade', color: 'orange', to: '/pro' },
            ]
        }},
        created() {
