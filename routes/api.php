...
//Route::group(['prefix' => 'method'], function() {
    Route::group(['prefix' => 'user'], function() {
        Route::group(['namespace' => 'User'], function() {
            ...
            */
            ...
            Route::get('me/following/notification', 'FollowingController@getNotifications')->middleware(['jwt.auth']);
            ...
            Route::get('{user}/liked_track', 'TrackController@getLiked');
    ...
    Route::group(['namespace' => 'Compilation', 'prefix' => 'compilation'], function() {
        /*
         * Compilation/CompilationController
         */

        Route::get('/ten', 'CompilationController@getTen');
        Route::get('/winners', 'CompilationController@getWinners');
        Route::get('/party', 'CompilationController@getParty');
        Route::get('/classic', 'CompilationController@getClassic');
        Route::get('/heavy', 'CompilationController@getHeavy');
    });
